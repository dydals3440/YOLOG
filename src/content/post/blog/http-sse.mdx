...
![SSE 연결 성공](/images/http-sse/1.webp)

![실제로 메시지를 받고도 계속해서 SSE 연결이 유지 됨](/images/http-sse/2.webp)
...
![두번째 메시지도 정상 수신됨을 확인할 수 있음](/images/http-sse/3.webp)
...
![Last-Event-ID 헤더 전송](/images/http-sse/6.webp)
