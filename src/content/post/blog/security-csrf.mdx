...
category: HTTP
image: '/images/security-csrf/thumbnail.png'
---

# CSRF(Cross-Site Request Forgery) 완벽 가이드: 실습으로 이해하는 교차 사이트 요청 위조
...
![CSRF 공격](/images/security-csrf/thumbnail.png)
...
![Firefox 브라우저 보안 설정 해제](/images/security-csrf/1.png)
...
![matthew.com 로그인 및 세션 쿠키 발급](/images/security-csrf/2.png)
...
![hacker.com:8082 접속 화면](/images/security-csrf/3.png)
...
![CSRF 공격: 인증 쿠키가 자동으로 전송됨](/images/security-csrf/4.png)
...
![SameSite=Strict 쿠키 설정 확인](/images/security-csrf/5.png)
...
![SameSite 적용 후: 쿠키가 전송되지 않음](/images/security-csrf/6.png)
...
![MDN: SameSite 쿠키 문서](/images/security-csrf/7.png)
...
![Can I Use: SameSite 브라우저 지원 현황](/images/security-csrf/8.png)
...
![Google reCAPTCHA 예시 - CAPTCHA는 이런 것을 의미해요](/images/security-csrf/9.png)
