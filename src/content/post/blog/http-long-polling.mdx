...
이번에는 그보다 발전된 기법인 **롱 폴링**을 이해하고 구현해보겠습니다.
...
다음 글에서는 롱 폴링의 한계를 극복하는 기술, [`SSE(Server-Sent Events)`](https://www.yolog.co.kr/post/http-sse)와 [WebSocket](https://www.yolog.co.kr/post/http-websocket)을 살펴보겠습니다.
