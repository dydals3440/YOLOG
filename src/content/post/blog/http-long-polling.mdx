...
| 구분          | [폴링(Polling)](https://www.yolog.co.kr/post/http-polling)         | 롱 폴링(Long Polling)              |
| ------------- | --------------------- | ---------------------------------- |
...
다음 글에서는 롱 폴링의 한계를 극복하는 기술, [`SSE(Server-Sent Events)`](https://www.yolog.co.kr/post/http-sse)와 `WebSocket`을 살펴보겠습니다.
